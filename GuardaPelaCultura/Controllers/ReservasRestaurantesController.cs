...
namespace GuardaPelaCultura.Controllers
{
    public class ReservasRestaurantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReservasRestauranteId,NomeRestaurante,NumeroTelefone,Descrição")] ReservasRestaurante reservasRestaurante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReservasRestauranteId,NomeRestaurante,NumeroTelefone,Descrição")] ReservasRestaurante reservasRestaurante)
        {
